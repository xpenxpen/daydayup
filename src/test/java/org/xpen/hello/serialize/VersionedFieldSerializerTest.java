...
/**
 * Kryo向后兼容性演示
 * 1)先单独运行testVersion1，写入老版本二进制
 * 2)将最后一行TestClass.zzz注释放开，再单独运行testVersion2，发现第一步写入的老的二进制仍然可读，证明向后兼容性OK
 */
public class VersionedFieldSerializerTest {
