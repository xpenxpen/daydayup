...
/**
 * 演示用poi生成一个带简单pivot table的xlsx文件
 *
 */
public class CreatePivotTableTest {
    
    public static final String RESULT = "target/ooxml-pivottable.xlsx";

    @Test
    public void testPivotTable() throws FileNotFoundException, IOException, InvalidFormatException {
