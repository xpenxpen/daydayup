...
public class P127WordLadder {
    public int ladderLength(String beginWord, String endWord, Set<String> wordList) {
        ...
        //List<String> reverseDict = new ArrayList<String>();
        
        int index = 0;
        for (String word: wordList) {
            words.put(word, index);
            //reverseDict.add(word);
            index++;
        }
        ...
        for (int i =0;i<size;i++) {
            List<String> wordsToSort = new ArrayList<String>();
            Map<String, Integer> sortedWords = new HashMap<String, Integer>();
            index = 0;
            for (String word: wordList) {
                String newWord = shiftWord(word, size, i);
                wordsToSort.add(newWord);
                sortedWords.put(newWord, index);
                index++;
            }
...
//        for (Map.Entry<String, Integer> word1 : words.entrySet()) {
//            for (Map.Entry<String, Integer> word2 : words.entrySet()) {
//                if (word1.getKey().compareTo(word2.getKey()) < 0 && isNeighbor(word1.getKey(), word2.getKey())) {
//                    G.addEdge(word1.getValue(), word2.getValue());
//                }
//            }
//        }
...
//             for (int v : bfs.pathTo(words.get(to))) {
//                 System.out.println(reverseDict.get(v));
//             }
             return bfs.distTo(words.get(to)) + 1;
         }
    ...
    private String shiftWord(String word, int totalLength, int shiftLength) {
        ...
        return word.substring(totalLength - shiftLength) + word.substring(0, totalLength - shiftLength);
    }
    ...
    public static void main(String[] args) {
        P127WordLadder main = new P127WordLadder();
